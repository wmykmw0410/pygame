# ex03: 攻撃ターンを追加して完成させる
# → ex02 に敵の反撃・全滅チェック・メッセージリストを追加する
# → max_hp を Character に追加し、Enemy にも attack を持たせて反撃できるようにする
...
pg.display.set_caption("ex03: バトルゲーム（完成）")
clock  = pg.time.Clock()
...
# ── ex02 との違い: Character に max_hp を追加した ──
class Character():
