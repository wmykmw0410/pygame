# ex03: Character 基底クラスを作り、Player・Enemy を派生させる
# → Character を定義してから Player、次に Enemy の順で派生させる
...
pg.display.set_caption("ex03: Character → Player / Enemy")
clock  = pg.time.Clock()
...
# ── ex02 との違い: Character 基底クラスを作り、Player・Enemy の順に派生させた ──
class Character():
