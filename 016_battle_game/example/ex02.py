# ex02: パーティー化する（勇者1人 → 3人のパーティー）
# → ex01 の Character に take_damage() を追加し、Player/Enemy は見た目(rect/color)を持つ
# → ダメージ計算にランダム幅を持たせ、Enemy は複数のPlayerを相手にする
...
pg.display.set_caption("ex02: Character → Player / Enemy")
clock  = pg.time.Clock()
