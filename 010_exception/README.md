...
例外が発生してもしなくても、最後に必ず実行される。ファイルのクローズや後片付けに使う
...
try:
    ...
    print("プログラムを終了します。")  # 例外の有無にかかわらず実行される
```
...
サンプル: [example/ex08.py](example/ex08.py) / [example/ex09.py](example/ex09.py)
...
サンプル: [example/ex10.py](example/ex10.py) / [example/ex11.py](example/ex11.py)
